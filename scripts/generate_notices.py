...
def generate_notices():
    ...
    if not prod_packages:
        print(
            "Warning: Could not determine production packages. "
            "Detailed python licenses might include dev tools."
        )
    ...
    # Actually, pip-licenses doesn't have a simple "only these and their deps" flag easily accessible without
    # graph analysis.
